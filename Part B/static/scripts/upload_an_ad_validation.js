document.addEventListener("DOMContentLoaded", () => {
    ...
    form.addEventListener("submit", (event) => {
        ...
        if (!validateImageUpload(imageUploadInput.files)) {
            errorMessage = "נא להעלות לפחות 2 תמונות";
